...
public void onClickFeature (View v)
{
    int id = v.getId ();
    switch (id) {
      case R.id.home_btn_recibir :
           startActivity (new Intent(getApplicationContext(), RecepcionCP.class));
           break;
      case R.id.home_btn_transmitir :
           startActivity (new Intent(getApplicationContext(), EnviarVentas.class));
           break;
      case R.id.home_btn_resumen :
           startActivity (new Intent(getApplicationContext(), VentasResumen.class));
           break;
      case R.id.home_btn_configurar :
           startActivity (new Intent(getApplicationContext(), ActivityConfiguracion.class));
           break;
      case R.id.home_btn_ventas :
           startActivity (new Intent(getApplicationContext(), VentaRegistros.class));
           break;
...
{
    final Intent intent = new Intent(context, MainDipalza.class);
